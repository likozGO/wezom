        ...
        <div className="container">
          <div className="row no-gutters h-100">
            ...
            <div className="col-8 d-flex justify-content-end">
              <button type="button" className="btn section-navigation--login">Вход</button>
            </div>
          </div>
        </div>
      </section>
      <section className="section-information">
        <div className="container">
          <div className="row no-gutters align-items-center" style={{ marginRight: '-20px' }}>
            ...
            <div className="col-5 offset-1 d-flex align-content-center">
              <div className="telephone-group">
                ...
                <button type="button" className="btn telephone-button">Перезвонить мне</button>
              </div>
            </div>
            <div className="col-3 offset-1 d-flex justify-content-around" style={{ paddingRight: '20px' }}>
